...
";
    ...
    {
        $userPhoto = "/Lb/images/" . $currentUser['photo'];
...
<header>
    <nav class='container' style='height: 80px; justify-content: space-around; min-width: fit-content'>
        <a class='logo mr-4' href='/index.php'>
            <img class='logo' src='/Lb/images/logo.svg' alt='logo'/>
        </a>
        <div class='container' style='justify-content: space-evenly'>
            <button class='secondaryBtn'>Find recipe</button>
            <a href='/Lb/views/adding-recipe-page.php'>
                <button class='secondaryBtn'>Add recipe</button>
            </a>
        </div>
        <div class='container'>
            <a class='nav-link active' aria-current='page' href='/#'>
                <img src='/Lb/images/telegram.svg' alt='telegram'>
            </a>
            <a class='nav-link' href='/#'>
                <img src='/Lb/images/facebook.svg' alt='facebook'>
            </a>.
            <a class='nav-link' href='/#'>
                <img src='/Lb/images/instagram.svg' alt='instagram'>
            </a>
        </div>
...
<footer>
    <div class='container-fluid container d-flex align-items-center justify-content-space-between'>
        <img src='/Lb/images/logo.svg' alt='logo' class='logo'/>
